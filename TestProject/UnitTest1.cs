...
namespace TestProject
{
    ...
    public class UnitTest1
    {
        ...
        private string tvFile = @"C:\Users\marko\Videos\tv";
 ...
 *                    private string[] tvFile = Directory.GetFiles(@"C:\Users\marko\Videos\tv");
 *                    
*/       
        ...
        {
            schedule = new TvSchedule();

            Assert.IsNotNull(schedule.ReturnRandomFile(tvFile));
